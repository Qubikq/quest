...
class Warrior(MainCharacter):
    ...
    def __init__(self, name, age, weapon_type=weapon_bd.weapon_types[0].name, spec_name='Воин', hp=50,
...
class Mage(MainCharacter):
    ...
    def __init__(self, name, age, weapon_type=weapon_bd.mage_weapon_types[0].name, spec_name='Маг', hp=30,
...
class Archer(MainCharacter):
    ...
    def __init__(self, name, age, weapon_type=weapon_bd.archer_weapon_types[0].name, spec_name='Лучник',
